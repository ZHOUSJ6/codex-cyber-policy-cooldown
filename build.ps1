# Build the codex-cyber-policy-cooldown plugin into a Windows .dll.
#
# Requirements:
...
#    name without the extension: "codex-cyber-policy-cooldown".)

$ErrorActionPreference = "Stop"

$out = "codex-cyber-policy-cooldown.dll"
